...
.market-news-stocks{display:inline-flex;gap:5px;flex:0 0 auto;padding-left:0;}
.market-news-impact .live-meta{display:none;}
.market-news-stocks .live-affected-label{font-size:9px;letter-spacing:0.04em;margin-right:0;color:#cbd5e1;}
.market-news-stocks .live-stock-link{gap:4px;padding:4px 6px;font-size:9px;line-height:1;white-space:nowrap;text-transform:none;}
.market-news-stocks .live-stock-link::before{width:5px;height:5px;}
.market-news-stocks .live-stock-action{font-size:8px;padding-left:4px;}
.live-stock-more,.live-market-wide{display:inline-flex;align-items:center;border-radius:999px;padding:4px 6px;font-size:9px;font-weight:900;line-height:1;white-space:nowrap;color:#cbd5e1;background:rgba(148,163,184,0.10);border:1px solid rgba(148,163,184,0.22);}
            ...
            <div class="live-alert-track" id="marketNewsTrack" aria-live="polite" data-refresh-interval="{{ market_news_refresh_interval_ms }}">
                ...
                <span class="live-headline {% if repeat %}ticker-duplicate{% endif %}" {% if repeat %}aria-hidden="true"{% endif %}>
                    ...
                    <span class="live-headline-details market-news-stocks">
                        ...
                        {% for stock in headline.get('stock_links', [])[:3] %}
                        ...
                        {% if stock_link_total > 3 %}
                        <span class="live-stock-more">+{{ stock_link_total - 3 }} more</span>
                        {% endif %}
                        {% else %}
