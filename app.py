...
<div class="card chart-card">{% if chart_data.ok %}<div class="chart-shell"><canvas id="stockChart"></canvas></div>{% else %}<h2>Chart unavailable</h2><p style="color:#fca5a5;">{{ chart_data.error }}</p>{% endif %}</div>
